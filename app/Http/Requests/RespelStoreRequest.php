    ...
    public function rules()
        {
            ...
            $rules = [
                ...
                'RespelHojaSeguridad.*' => 'sometimes|max:2048|mimes:pdf|required_unless:RespelIgrosidad.*,No peligroso',
                ...
                'SustanciaControladaNombre.*'   => 'sometimes|max:50|string|nullable|in:',
