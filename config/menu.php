...
Menu::macro('sidebar', function () {//COMIENZO DEL SIDEBAR EN VERSION DE MENU
    return Menu::adminlteMenu()
        ...
        ->add(Menu::new()
            ...
            /*UN SUBMENU */
            ->add(Menu::new()
                ->prepend('<a href="#"><i class="fa fa-building"></i> <span>Sedes</span><i class="fas fa-angle-left pull-right"></i></a>')
                ->addParentClass('treeview')
        ...
        ->add(Menu::new()
            ...
            ->addClass('treeview-menu')
            ->add(Menu::new()
                ->prepend('<a href="#"><i class="fa fa-building"></i> <span>Sede Generador</span><i class="fas fa-angle-left pull-right"></i> </a>')
                ->addParentClass('treeview')
        ...
        ->add(Menu::new()
            ->prepend('<a href="#"><i class="fas fa-truck-moving"></i> <span>Vehiculos</span><i class="fas fa-angle-left pull-right"></i></a>')
            ->addParentClass('treeview')
        ...
        /*PESTAÑA DE COMPRA*/
        ->add(Menu::new()
            ->prepend('<a href="#"><i class="fas fa-money-bill-wave"></i> <span>Compra</span><i class="fas fa-angle-left pull-right"></i></a>')
            ->addParentClass('treeview')
        ...
        /*PESTAÑA DE ACTIVOS*/
        ->add(Menu::new()
            ->prepend('<a href="#"><i class="fas fa-laptop"></i> <span>Activos</span><i class="fas fa-angle-left pull-right"></i></a>')
            ->addParentClass('treeview')
        ...
        ->add(Menu::new()
            ->prepend('<a href="#"><i class="fas fa-people-carry"></i> <span>Solicitud</span><i class="fas fa-angle-left pull-right"></i></a>')
            ->addParentClass('treeview')
