			...
			/*INICIO DEL MENU1 PARA PROSARC*/
				...
				->addIf(in_array(Auth::user()->UsRol, Permisos::TODOPROSARC) || in_array(Auth::user()->UsRol2, Permisos::TODOPROSARC),
					(Menu::new()
						...
						->addIf(in_array(Auth::user()->UsRol, Permisos::TODOPROSARC) || in_array(Auth::user()->UsRol2, Permisos::TODOPROSARC), (Link::toUrl('/manifiestos', '<i class="fas fa-file-invoice"></i> <span>'. trans('adminlte_lang::message.MenuManifiestos').'</span>')))
						->addClass('treeview-menu')
					)
				)
			...
			/*INICIO DEL MENU PARA CLIENTE*/
				...
				->addIf(in_array(Auth::user()->UsRol, Permisos::CLIENTE) || in_array(Auth::user()->UsRol2, Permisos::CLIENTE),
					(Menu::new()
						...
						->addIf(in_array(Auth::user()->UsRol, Permisos::CLIENTE) || in_array(Auth::user()->UsRol2, Permisos::CLIENTE), (Link::toUrl('/manifiestos', '<i class="fas fa-file-invoice"></i> <span>'. trans('adminlte_lang::message.MenuManifiestos').'</span>')))
						->addClass('treeview-menu')
					)
				)
