			...
			/*INICIO DEL MENU1 PARA PROSARC*/
				...
				->addIf(in_array(Auth::user()->UsRol, Permisos::TODOPROSARC) || in_array(Auth::user()->UsRol2, Permisos::TODOPROSARC),
					(Menu::new()
						...
						->addIf(in_array(Auth::user()->UsRol, Permisos::ProgVehic2) || in_array(Auth::user()->UsRol2, Permisos::ProgVehic2), (Link::toUrl('/verificationcodes', '<i class="fas fa-hashtag"></i> <span>Códigos de Verificación</span>')))
