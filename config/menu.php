    ...
    if (Auth::user()->email_verified_at <> null && Auth::user()->FK_UserPers <> NULL) {
        return Menu::adminlteMenu()
            ...
            /*TITULO DEL MENU1 PARA PROSARC*/
				...
				->addIf(Auth::user()->UsRol <> trans('adminlte_lang::message.Cliente'),(Link::toUrl(route('cliente-show', Cliente::where('ID_Cli', userController::IDClienteSegunUsuario())->first()->CliSlug), '<i class="fas fa-user-shield"></i> <span>'. trans('adminlte_lang::message.MenuClien2').'</span>')))
	            ...
	            /*PESTAÑA DE PERSONAL*/
		        ->addIf(in_array(Auth::user()->UsRol, Permisos::MenuPersonalInterno) || in_array(Auth::user()->UsRol2, Permisos::MenuPersonalInterno),
			        (Menu::new()
				        ...
				        ->add(Link::toUrl('/personalInterno', '<i class="fas fa-list-alt"></i> '.trans('adminlte_lang::message.MenuPerslist')))
