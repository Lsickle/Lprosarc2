			...
			/*INICIO DEL MENU1 PARA PROSARC*/
				...
				->addIf(in_array(Auth::user()->UsRol, Permisos::TODOPROSARC) || in_array(Auth::user()->UsRol2, Permisos::TODOPROSARC),
					(Menu::new()
						...
						->addIf(in_array(Auth::user()->UsRol, Permisos::EXPRESS) || in_array(Auth::user()->UsRol2, Permisos::EXPRESS), (Link::toUrl('/serviciosexpress', '<i class="fas fa-truck-moving"></i> <span>Servicios Express</span>')))
