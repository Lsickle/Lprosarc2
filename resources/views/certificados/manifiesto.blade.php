...
<table class=MsoNormalTable border=1 cellspacing=0 cellpadding=0
 ...
 <tr>
  <td width=415 valign=top style='width:311.6pt;border:solid black 1.0pt;
...
<table class=MsoNormalTable border=1 cellspacing=0 cellpadding=0 width=536
 ...
 <tr>
  <td width=162 style='width:121.65pt;border:solid black 1.0pt;padding:0cm 5.4pt 0cm 5.4pt'>
  <p class=MsoNormal><span lang=ES style='font-size:7.5pt;font-family:"Arial",sans-serif;
  color:#0D0D0D'>Fecha de Recepción</span></p>
  </td>
  <td width=373 colspan=3 style='width:280.05pt;border:solid black 1.0pt;
  border-left:none;padding:0cm 5.4pt 0cm 5.4pt'>
  <p class=MsoNormal><span lang=ES style='font-size:7.5pt;font-family:"Arial",sans-serif;
  color:#0D0D0D'>@php 
 ...
 <tr>
  <td width=162 style='width:121.65pt;border:solid black 1.0pt;border-top:none;
  padding:0cm 5.4pt 0cm 5.4pt'>
  <p class=MsoNormal><span lang=ES style='font-size:7.5pt;font-family:"Arial",sans-serif;
 ...
 <tr>
  ...
  padding:0cm 5.4pt 0cm 5.4pt'>
  <p class=MsoNormal><span lang=ES style='font-size:7.5pt;font-family:"Arial",sans-serif;
  color:#0D0D0D'>Tipo de Material</span></p>
  </td>
  <td width=373 colspan=3 style='width:280.05pt;border-top:none;border-left:
  none;border-bottom:solid black 1.0pt;border-right:solid black 1.0pt;
  padding:0cm 5.4pt 0cm 5.4pt'>
  <p class=MsoNormal><span lang=ES style='font-size:7.5pt;font-family:"Arial",sans-serif;
  color:#0D0D0D'>Pendiente (Industrial)</span></p>
  </td>
 </tr>
@php
$totalfilas=1;
...
@endforeach
 <tr style='height:11.1pt'>
  <td width=162 rowspan={{$totalfilas}} style='width:121.65pt;border:solid black 1.0pt;
...
<p class=MsoNormal style='text-align:justify'><span lang=ES style='font-size:
7.5pt;font-family:"Arial",sans-serif;color:#0D0D0D'>EL material será trasladado
a la planta {{$certificado->gestor->ID_Cli == 1 ? $certificado->gestor->CliShortname : $certificado->gestor->CliName}} para su {{$certificado->tratamiento->TratName}} de acuerdo con los
requerimientos técnicos y ambientales establecidos.</span></p>
