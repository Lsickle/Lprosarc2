...
<table class=MsoNormalTable border=1 cellspacing=0 cellpadding=0
 ...
 <tr>
  ...
  <p class=MsoNormal style='text-align:justify'><span lang=ES style='font-size:
  7.5pt;font-family:"Arial",sans-serif'>Dirección: <b>{{$certificado->sedegenerador->GSedeAddress}} (Municipio:{{$certificado->sedegenerador->municipio->MunName}}) (Sede:{{$certificado->sedegenerador->GSedeName}})</b></span></p>
  </td>
