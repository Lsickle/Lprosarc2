                                        ...
                                        <div id="step-1" class="tab-pane step-content" class="Formcontacto">
                                            <div id="form-step-0" role="form" data-toggle="validator" class="Formcontacto">
                                                ...
                                                <div id="AddVehiculoPlaca" class="col-md-6 form-group" style="display:none;">
                                                    ...
                                                    <input type="text" name="VehicPlaca" class="form-control placa" id="VehicPlaca" data-minlength="7" maxlength="7" placeholder="{{ trans('adminlte_lang::message.placaplaceholder') }}" value="{{ old('VehicPlaca') }}">
                                                </div>
                                            ...
                                            <div id="form-step-1" role="form" data-toggle="validator">
                                                ...
                                                <div class="col-md-6 form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" class="form-control mobile" id="sedeinputcelular" placeholder="{{ trans('adminlte_lang::message.mobileplaceholder') }}" name="SedeCelular" data-minlength="12" value="{{ old('SedeCelular') }}">
                                                    </div>
                                                </div>
                                                <div class="form-group col-md-6">
                                                ...
                                                <div class="col-md-6 form-group">
                                                    ...
                                                    <input type="text" class="form-control phone tel" id="sedeinputphone1" name="SedePhone1" data-minlength="11" placeholder="{{ trans('adminlte_lang::message.phoneplaceholder') }}" value="{{ old('SedePhone1') }}">
                                                </div>
                                                <div class="col-md-6 form-group">
                                                ...
                                                <div id="telefono2" class="col-md-6 form-group" style="display: none;">
                                                    ...
                                                    <input type="tel" class="form-control phone tel2" id="sedeinputphone2" name="SedePhone2" data-minlength="11" placeholder="{{ trans('adminlte_lang::message.phoneplaceholder') }}" data-maxlength="11" value="{{ old('SedePhone2') }}">
                                                </div>
