						...
						<ul class="list-group list-group-unbordered">
							...
							<li class="list-group-item">
								...
								<select name="RespelStatus" class="form-control">
									...
									<option {{(in_array(Auth::user()->UsRol, Permisos::JefeComercial)||in_array(Auth::user()->UsRol2, Permisos::JefeOperaciones))||($Respels->RespelStatus == 'Aprobado') ? '' : 'disabled'}} {{$Respels->RespelStatus == 'Aprobado' ? 'selected' : '' }}>{{ trans('adminlte_lang::LangRespel.respelstatusaprovado') }}</option>
