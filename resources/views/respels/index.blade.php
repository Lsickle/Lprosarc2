								...
								@foreach($Respels as $respel)
									...
									@else
										@switch($respel->RespelStatus)
											...
											{{-- residuo Evaluado --}}
											@case('Evaluado')
												<td class="text-center"><a method='get' href='/respels/{{$respel->RespelSlug}}' data-placement="auto" data-trigger="hover" data-html="true" data-toggle="popover" title="<b>Status Evaluado</b>" data-content="<p style='width: 50%'> el Residuo ya posee un tratamiento viable asignados, sin embargo, el <b>Asesor Comercial</b> debe asignar las tarifas de acuerdo al tratamiento y ofertar alguna de las opciones... <br>Para mas detalles comuníquese con el <b>Jefe de Operaciones</b></p>" class='btn fixed_widthbtn btn-primary'><i class='fas fa-lg fa-list'></i></a></td>
												@break
											{{-- residuo Cotizado --}}
											@case('Cotizado')
