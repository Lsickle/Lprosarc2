		...
		@if($requerimiento->FK_ReqTrata == $tratamientoelegido->ID_Trat)
			<div style="margin-top: 0.25em;">
				<div class="col-md-2 col-xs-6">
					...
					<input {{$requerimiento->ReqFotoDescargue == 1 ? 'checked' : ""}} value="1" type="checkbox" class="pull-bottom fotoswitch" name="Opcion[{{$contadorphp}}][ReqFotoDescargue]"/>
					</label>
				</div>
				<div class="col-md-2 col-xs-6">
					...
					<input {{$requerimiento->ReqFotoDestruccion == 1 ? 'checked' : ""}} value="1" type="checkbox" class="pull-bottom fotoswitch" name="Opcion[{{$contadorphp}}][ReqFotoDestruccion]"/>
					</label>
				</div>
				<div class="col-md-2 col-xs-6 col-md-offset-1">
					...
					<input {{$requerimiento->ReqVideoDescargue == 1 ? 'checked' : ""}} value="1" type="checkbox" class="pull-bottom videoswitch" name="Opcion[{{$contadorphp}}][ReqVideoDescargue]"/>
					</label>
				</div>
				<div class="col-md-2 col-xs-6">
					...
					<input {{$requerimiento->ReqVideoDestruccion == 1 ? 'checked' : ""}} value="1" type="checkbox" class="pull-bottom videoswitch" name="Opcion[{{$contadorphp}}][ReqVideoDestruccion]"/>
					</label>
				</div>
				<div class="col-md-2 col-xs-6 col-md-offset-1">
					...
					<input {{$requerimiento->ReqDevolucion == 1 ? 'checked' : ""}} value="1" type="checkbox" class="pull-bottom embalajeswitch" name="Opcion[{{$contadorphp}}][ReqDevolucion]"/>
					</label>
				</div>
			</div>
			@endif
