...
<div id="requerimiento{{$contadorphp}}Container" class="panel panel-default" style="display: inline-block; overflow: hidden; width:100%; background-color:#FAFAFF;">
	...
	<div>
		...
		<div class="col-md-2 col-xs-6">
			...
			<input id="ReqFotoDestruccion{{$contadorphp}}" {{(in_array(Auth::user()->UsRol, Permisos::JefeOperaciones)||in_array(Auth::user()->UsRol2, Permisos::JefeOperaciones)) && ($OpcionOfertada==0) ? '' : 'disabled=true' }} {{$opcion['ReqFotoDestruccion'] == 1 ? 'checked' : ""}} value="1" type="checkbox" class="fotoswitch" name="Opcion[{{$contadorphp}}][ReqFotoDestruccion]"/>
			</label>
		...
		<div class="col-md-2 col-xs-6">
			...
			<input id="ReqVideoDescargue{{$contadorphp}}" {{(in_array(Auth::user()->UsRol, Permisos::JefeOperaciones)||in_array(Auth::user()->UsRol2, Permisos::JefeOperaciones)) && ($OpcionOfertada==0) ? '' : 'disabled=true' }} {{$opcion['ReqVideoDescargue'] == 1 ? 'checked' : ""}} value="1" type="checkbox" class="videoswitch" name="Opcion[{{$contadorphp}}][ReqVideoDescargue]"/>
			</label>
		...
		<div class="col-md-2 col-xs-6">
			...
			<input id="ReqVideoDestruccion{{$contadorphp}}" {{(in_array(Auth::user()->UsRol, Permisos::JefeOperaciones)||in_array(Auth::user()->UsRol2, Permisos::JefeOperaciones)) && ($OpcionOfertada==0) ? '' : 'disabled=true' }} {{$opcion['ReqVideoDestruccion'] == 1 ? 'checked' : ""}} value="1" type="checkbox" class="videoswitch" name="Opcion[{{$contadorphp}}][ReqVideoDestruccion]"/>
			</label>
		...
		<div class="col-md-2 col-xs-6">
			...
			<input id="ReqDevolucion{{$contadorphp}}" {{(in_array(Auth::user()->UsRol, Permisos::JefeOperaciones)||in_array(Auth::user()->UsRol2, Permisos::JefeOperaciones)) && ($OpcionOfertada==0) ? '' : 'disabled=true' }} {{$opcion['ReqDevolucion'] == 1 ? 'checked' : ""}} value="1" type="checkbox" class="embalajeswitch" name="Opcion[{{$contadorphp}}][ReqDevolucion]"/>
			</label>
		...
		<div class="col-md-2 col-xs-6">
			...
			<input id="ReqAuditoria{{$contadorphp}}" {{(in_array(Auth::user()->UsRol, Permisos::JefeOperaciones)||in_array(Auth::user()->UsRol2, Permisos::JefeOperaciones)) && ($OpcionOfertada==0) ? '' : 'disabled=true' }} {{$opcion['ReqAuditoria'] == 1 ? 'checked' : ""}} value="1" type="checkbox" class="auditoriaswitch" name="Opcion[{{$contadorphp}}][ReqAuditoria]"/>
			</label>
		 	@if((in_array(Auth::user()->UsRol, Permisos::ComercialYJefeComercial)||in_array(Auth::user()->UsRol2, Permisos::ComercialYJefeComercial))&&($opcion['ReqAuditoria'] == 1))
		    	<input hidden name="Opcion[{{$contadorphp}}][ReqAuditoria]" value="1">
		    @endif
		    @if((in_array(Auth::user()->UsRol, Permisos::JefeOperaciones)||in_array(Auth::user()->UsRol2, Permisos::JefeOperaciones))&&($opcion['ReqAuditoria'] == 1)&&($OpcionOfertada==1))
		    	<input hidden name="Opcion[{{$contadorphp}}][ReqAuditoria]" value="1">
		    @endif
		</div>
	</div>
