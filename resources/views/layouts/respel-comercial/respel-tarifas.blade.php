<div class="panel panel-default" style="display: inline-block; overflow: hidden; width:100%; background-color:#FAFAFF;">
	...
	<div class="pull-right col-md-2">
		...
		<button onclick="AgregarRango(`+contador+`)" class="btn btn-primary addrangeButton" id="addrangeButton"> <i class="fa fa-plus"></i></button>
		<button onclick="EliminarRango(`+contador+`)" class="btn btn-danger minusrangeButton" id="minusrangeButton"> <i class="fa fa-minus"></i></button>
	</div>
</div>