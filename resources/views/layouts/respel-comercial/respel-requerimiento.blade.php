<div id="requerimiento`+contador+`Container" class="panel panel-default" style="display: inline-block; overflow: hidden; width:100%; background-color:#FAFAFF;">
		<div style="margin-top: 0.25em;">
			<div class="col-md-2 col-xs-6">
				...
				<input type="checkbox" class="pull-bottom fotoswitch" name="Tratamiento[Requerimientos[`+contador+`][ReqFotoDescargue]]"/>
				</label>
			</div>
			<div class="col-md-2 col-xs-6">
				...
				<input type="checkbox" class="pull-bottom fotoswitch" name="Tratamiento[Requerimientos[`+contador+`][ReqFotoDestruccion]]"/>
				</label>
			</div>
			<div class="col-md-2 col-xs-6 col-md-offset-1">
				...
				<input type="checkbox" class="pull-bottom videoswitch" name="Tratamiento[Requerimientos[`+contador+`][ReqVideoDescargue]]"/>
				</label>
			</div>
			<div class="col-md-2 col-xs-6">
				...
				<input type="checkbox" class="pull-bottom videoswitch" name="Tratamiento[Requerimientos[`+contador+`][ReqVideoDestruccion]]"/>
				</label>
			</div>
			<div class="col-md-2 col-xs-6 col-md-offset-1">
				...
				<input type="checkbox" class="pull-bottom embalajeswitch" name="Tratamiento[Requerimientos[`+contador+`][ReqDevolucion]]"/>
				</label>
			</div>
		</div>
</div>
