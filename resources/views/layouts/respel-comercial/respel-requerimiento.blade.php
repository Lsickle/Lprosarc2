<div id="requerimiento`+contador+`Container" class="panel panel-default" style="display: inline-block; overflow: hidden; width:100%; background-color:#FAFAFF;">
		<div style="margin-top: 0.25em;">
			<div class="col-md-2 col-xs-6">
				...
				<input type="checkbox" class="pull-bottom fotoswitch" name="Opcion[`+contador+`][ReqFotoDescargue]"/>
				</label>
			</div>
			<div class="col-md-2 col-xs-6">
				...
				<input type="checkbox" class="pull-bottom fotoswitch" name="Opcion[`+contador+`][ReqFotoDestruccion]"/>
				</label>
			</div>
			<div class="col-md-2 col-xs-6 col-md-offset-1">
				...
				<input type="checkbox" class="pull-bottom videoswitch" name="Opcion[`+contador+`][ReqVideoDescargue]"/>
				</label>
			</div>
			<div class="col-md-2 col-xs-6">
				...
				<input type="checkbox" class="pull-bottom videoswitch" name="Opcion[`+contador+`][ReqVideoDestruccion]"/>
				</label>
			</div>
			<div class="col-md-2 col-xs-6 col-md-offset-1">
				...
				<input type="checkbox" class="pull-bottom embalajeswitch" name="Opcion[`+contador+`][ReqDevolucion]"/>
				</label>
			</div>
		</div>
</div>
