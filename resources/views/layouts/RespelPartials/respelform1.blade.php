	...
	<div id="Residuo">
		{{-- <div id="form-step-0" role="form" data-toggle="validator"> --}}
			...
			<div class="col-md-6 form-group has-feedback">
				...
				<small class="help-block with-errors">*</small>
				<input id="hoja0" name="RespelHojaSeguridad[]" type="file" data-validate="true" required data-filesize="2048" class="form-control" accept=".pdf">
			</div>
			<div class="col-md-6 form-group has-feedback">
			...
			<div class="col-md-6 form-group has-feedback">
				...
				<small class="help-block with-errors"></small>
				<input id="foto0" name="RespelFoto[]" type="file" class="form-control" accept=".jpg,.png" data-filesize="2048" value="{{ old('RespelFoto.0') }}">
