...
<div class="col-md-6" style="padding-top: 18px;">
	...
	<label style="margin: 0 3em;">
		<spam> Y </spam>
		<input type="radio" id="ClasifY" onclick="Agregar()" name="ResTippCasif" checked="" value="Y">
	</label>
	<label>
		<spam> A </spam>
...
<div class="col-md-6" id="Clasif">
	<label >Clasificacion Y, segun <a href="{{route('ClasificacionY')}}" target="_blank"> Decreto Número 4741</a></label>
