		...
		{{-- <div id="form-step-0" role="form" data-toggle="validator"> --}}
			...
			<div class="col-md-6 form-group has-feedback">
				...
				<select name="RespelEstado" class="form-control" required>
					...
					<option {{ ($Respels->PRespelEstado === trans('adminlte_lang::LangRespel.estadofisico3') ? "selected" : "" )}} value="{{ trans('adminlte_lang::LangRespel.estadofisico3') }}">{{ trans('adminlte_lang::LangRespel.estadofisico3') }}</option>
					<option {{ ($Respels->PRespelEstado === trans('adminlte_lang::LangRespel.estadofisico4') ? "selected" : "" )}} value="{{ trans('adminlte_lang::LangRespel.estadofisico4') }}">{{ trans('adminlte_lang::LangRespel.estadofisico4') }}</option>
				</select>
			</div>
			<div class="col-md-6 form-group has-feedback">
			...
			<div class="col-md-6 form-group has-feedback" id="Clasif0">
				@if(is_null($Respels->ARespelClasf4741))
					@include('layouts.RespelPublicPartials.layoutsRes.ClasificacionYEdit')
				@else
					@include('layouts.RespelPublicPartials.layoutsRes.ClasificacionAEdit')
				@endif
			</div>
			@else
...
function AgregarY(id) {
	var ClasifY = `@include('layouts.RespelPublicPartials.layoutsRes.ClasificacionYEdit')`;
...
function AgregarA(id) {
	var ClasifA = `@include('layouts.RespelPublicPartials.layoutsRes.ClasificacionAEdit')`;
...
function AgregarControlada(id) {
	var ControladaName = `@include('layouts.RespelPublicPartials.layoutsRes.ControladaEditName')`;
	var ControladaDoc = `@include('layouts.RespelPublicPartials.layoutsRes.ControladaEditDoc')`;
...
function AgregarMasivo(id) {
	var MasivoName = `@include('layouts.RespelPublicPartials.layoutsRes.MasivoEditName')`;
	var MasivoDoc = `@include('layouts.RespelPublicPartials.layoutsRes.MasivoEditDoc')`;
