            ...
            <div class="box box-info">
                <div class="box-body box-profile">
                    <div class="col-md-12 col-xs-12">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div style="font-size: 5em; color: red; text-align: center; margin: auto;">
                                            ...
                                            <span style="font-size: 0.3em; color: black;">
                                                <p>¿Seguro quiere eliminar el cliente <b>{{$cliente->CliShortname}}</b>?</p>
                                            </span>
                                            <small>
                                                <h5>NOTA: Los datos dependientes a este registro seran eliminados</h5>
                                            </small>
                                        </div>
                                    </div>
                        ...
                        <a href="/clientexpress/{{$cliente->CliSlug}}/edit" class="btn btn-warning pull-right"><i class="fas fa-edit"></i><b> {{ trans('adminlte_lang::message.edit') }}</b></a>
                        @break
                        @default
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <div style="font-size: 5em; color: green; text-align: center; margin: auto;">
                    ...
                    <span style="font-size: 0.3em; color: black;">
                        <p>Requerimientos a solicitar</p>
                    </span>
                </div>
            </div>
