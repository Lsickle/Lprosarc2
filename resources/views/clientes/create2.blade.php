                                        ...
                                        <div id="step-2" class="">
                                            <div id="form-step-1" role="form" data-toggle="validator">
                                                ...
                                                <div class="col-md-6 form-group">
                                                    ...
                                                    <input type="text" class="form-control phone tel" id="sedeinputphone1" name="SedePhone1" placeholder="{{ trans('adminlte_lang::message.phoneplaceholder') }}" data-minlength="11" data-error="{{ trans('adminlte_lang::message.data-error-minlength10') }}" value="{{ old('SedePhone1') }}">
                                                </div>
                                                <div class="col-md-6 form-group">
                                                ...
                                                <div id="telefono2" class="col-md-6 form-group" style="display: none;">
                                                    ...
                                                    <input type="tel" class="form-control phone tel2" id="sedeinputphone2" name="SedePhone2" placeholder="{{ trans('adminlte_lang::message.phoneplaceholder') }}" data-minlength="11"  data-maxlength="11" data-error="{{ trans('adminlte_lang::message.data-error-minlength10') }}" value="{{ old('SedePhone2') }}">
                                                </div>
                                        ...
                                        <div id="step-3">
                                            <div id="form-step-2" role="form" data-toggle="validator">
                                                ...
                                                <div class="form-group col-md-6">
                                                    ...
                                                    <div class="input-group">
                                                        <span class="input-group-addon">(+57)</span>
                                                        <input type="text" class="form-control mobile" id="PersCellphone" name="PersCellphone" placeholder="{{ trans('adminlte_lang::message.mobileplaceholder') }}" data-minlength="12"  maxlength="12" data-error={{ trans('adminlte_lang::message.data-error-minlength10') }} value="{{ old('PersCellphone') }}" required>
                                                    </div>
                                                </div>
                                            </div>
