        ...
        <div class="col-md-3">
          ...
          <div class="box box-primary">
            <div class="box-body box-profile">
              ...
              <h3 class="profile-username text-center">{{$declaration->DeclarName}}</h3>

              <p class="text-muted text-center">{{$declaration->DeclarTipo}}</p>
          	...
          	<a href="/Generadores/{{$declaration->DeclarSlug}}/edit" class="btn btn-success btn-block"><b>Editar</b></a>
						<br>
{{--             <form action="/sclientes/create" class="form-group" method="POST">
              @csrf
                ...
                <button type="submit" class="btn btn-primary btn-block">Agregar Sede</button>
      			...
      			<form action="/Generadores/{{$declaration->ID_Declar}}" class="form-group" method="POST">
      				@csrf
      				@method('DELETE')
