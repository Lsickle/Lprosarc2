...
@section('htmlheader_title','Oficces')

@section('contentheader_title', 'Oficces Finales')
      ...
      <div class="col-md-16 col-md-offset-0">
        ...
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">Lista de Oficces</h3>
            <a href="oficces/create" class="btn btn-primary" style="float: right;">Crear</a>
          </div>
          <!-- /.box-header -->
          <div class="box-body">
            <table id="OficcesTable" class="table table-compact table-bordered table-striped">
              <thead>
                <tr>
                  <th>Modulo</th>
                  <th>Area</th>
