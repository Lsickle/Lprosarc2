									...
									<tr style="{{$Servicio->SolSerDelete == 1 ? 'color: red' : ''}}">
										...
										@else
											@switch($Servicio->SolSerStatus)
												...
												{{-- residuo Rechazado --}}
												@case('Aceptado')
													<td class="text-center"><a data-placement="auto" data-trigger="hover" data-html="true" data-toggle="popover" data-delay='{"show": 200}' title="<b>Status Rechazado</b>" data-content="<p style='width: 50%'>La solicitud de servicio ha sido aceptada por <b>Tesorería</b> y debe ser revisada por el Asistente de Logistica para validar las condiciones del servicio y las cantidades de los residuos... <br>Para más detalles comuníquese con el <b>Asistente de Logistica</b> </p>" class='btn fixed_widthbtn btn-info'><i class='fas fa-lg fa-thumbs-up'></i></a><br>{{$Servicio->SolSerStatus}}</td>
													@break
												{{-- residuo Evaluado --}}
												@case('Aprobado')
													<td class="text-center"><a data-placement="auto" data-trigger="hover" data-html="true" data-toggle="popover" data-delay='{"show": 200}' title="<b>Status Evaluado</b>" data-content="<p style='width: 50%'>La Solicitud ha sido revisada por el <b>Asistente de Logistica</b> satisfactoriamente se debe crear en el calendario las programaciones de servicios Necesarias para la recolección de los residuos correspondientes a esta solicitud... <br>Para más detalles comuníquese con el <b>Jefe de Logistica</b></p>" class='btn fixed_widthbtn btn-info'><i class='fas fa-lg fa-tasks'></i></a><br>{{$Servicio->SolSerStatus}}</td>
													@break
												{{-- residuo Cotizado --}}
												@case('Programado')
													<td class="text-center"><a data-placement="auto" data-trigger="hover" data-html="true" data-toggle="popover" data-delay='{"show": 200}' title="<b>Status Cotizado</b>" data-content="<p style='width: 50%'>Se han creado las programaciones de servicios necesarias para la recolección de los residuos correspondientes a esta solicitud... El área de <b>Tesorería</b> deberá autorizar dichas recolecciones/programaciones para que los conductores puedan visualizarlas y ejecutarlas en la fecha que corresponda <br>Para más detalles comuníquese con el <b>Jefe de Logistica o Tesoreria</b> según corresponda</p>" class='btn fixed_widthbtn btn-success'><i class='fas fa-lg fa-calendar-alt'></i></a><br>{{$Servicio->SolSerStatus}}</td>
													@break
												{{-- residuo Aprobado --}}
												@case('Notificado')
													<td class="text-center"><a data-placement="auto" data-trigger="hover" data-html="true" data-toggle="popover" data-delay='{"show": 200}' title="<b>Status Aprobado</b>" data-content="<p style='width: 50%'>El Área de tesorería ha autorizado la ejecución de las programaciones/recolecciones correspondientes a esta solicitud... adicionalmente se ha enviado una notificación por correo electrónico a la persona de contacto del cliente informando la fecha de la programación de servicio <br>Para más detalles comuníquese con el <b>Jefe de Logistica</b> </p>" class='btn fixed_widthbtn btn-primary'><i class='far fa-lg fa-envelope'></i></a><br>{{$Servicio->SolSerStatus}}</td>
													@break
												{{-- cotización vencida --}}
												@case('Recibido')
													<td class="text-center"><a data-placement="auto" data-trigger="hover" data-html="true" data-toggle="popover" data-delay='{"show": 200}' title="<b>Status Vencido</b>" data-content="<p style='width: 50%'>Las programaciones correspondientes a este servicio han sido recibidas en planta de procesos... el área de <b>RecepcionPDA</b> procederá a cargar la información de las cantidades recibidas y las fotos del pesaje/descargue de cada residuo  <br>Para más detalles comuníquese con <b>RecepcionPDA</b> </p>" class='btn fixed_widthbtn btn-danger'><i class='fas fa-lg fa-calendar-times'></i></a><br>{{$Servicio->SolSerStatus}}</td>
													@break
												{{-- información del residuo incompleta --}}
												@case('Completado')
													<td class="text-center"><a data-placement="auto" data-trigger="hover" data-html="true" data-toggle="popover" data-delay='{"show": 200}' title="<b>Status Incompleto</b>" data-content="<p style='width: 50%'>Todos los residuos de esta solicitud de servicio han sido recibidos en planta y se han cargado las cantidades correspondientes...  adicionalmente se envió un correo electrónico a la persona de contacto de esta solicitud para que revise las cantidades recibidas... se deberá esperar a que el cliente acepte o rechace los pesos enviados a conciliación <br>Para más detalles comuníquese con el <b>Asesor Comercial</b> </p>" class='btn fixed_widthbtn btn-success'><i class='fas fa-lg fa-truck-loading'></i></a><br>{{$Servicio->SolSerStatus}}</td>
													@break
												{{-- Residuo Revisado --}}
												@case('Conciliado')
													<td class="text-center"><a data-placement="auto" data-trigger="hover" data-html="true" data-toggle="popover" data-delay='{"show": 200}' title="<b>Status Revisado</b>" data-content="<p style='width: 50%'>El cliente ha aceptado las cantidades enviadas a conciliación y el Área de Operaciones puede comenzar con el tratamiento de los residuos... adicionalmente también se puede adelantar el proceso de certificación de los residuos con tratamiento de Termo-destrucción <br>Para más detalles comuníquese con el <b>Área de Logística u Operaciones</b> según corresponda </p>" class='btn fixed_widthbtn btn-success'><i class='fas fa-lg fa-balance-scale'></i></a><br>{{$Servicio->SolSerStatus}}</td>
													@break
												{{-- falta la TDE --}}
												@case('No Conciliado')
													<td class="text-center"><a data-placement="auto" data-trigger="hover" data-html="true" data-toggle="popover" data-delay='{"show": 200}' title="<b>Tarjeta de emergencia no valida</b>" data-content="<p style='width: 50%'>Algunas de las cantidades de residuos enviadas a conciliación han sido rechazada por el cliente... y se ha enviado un correo de notificación al Asistente de Logistica para la revisión de las cantidades <br>Para más detalles comuníquese con el <b>Asesor Comercial o Asistente de Logistica</b> según corresponda</p>" class='btn fixed_widthbtn btn-warning'><i class='fas fa-lg fa-balance-scale-right'></i></a><br>{{$Servicio->SolSerStatus}}</td>
													@break
												{{-- TDE actualizada --}}
												@case('Tratado')
													<td class="text-center"><a data-placement="auto" data-trigger="hover" data-html="true" data-toggle="popover" data-delay='{"show": 200}' title="<b>Tarjeta de emergencia actualizada</b>" data-content="<p style='width: 50%'>Todos los residuos de este servicio han sido tratados satisfactoriamente, sin embargo, el área de <b>Tesorería</b> deberá autorizar al cliente para la descarga de manifiestos/Certificados… Los Certificados de otros Gestores serán cargados en el Sistema SisPRO según se vayan recibiendo... <br>Para más detalles comuníquese con el <b>Jefe de Operaciones</b> </p>" class='btn fixed_widthbtn btn-primary'><i class='fas fa-lg fa-dumpster-fire'></i></a><br>{{$Servicio->SolSerStatus}}</td>
													@break
												@case('Certificacion')
