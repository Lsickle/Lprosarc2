									...
									<tr style="{{$Servicio->SolSerDelete == 1 ? 'color: red' : ''}}">
										...
										@else
											@switch($Servicio->SolSerStatus)
												...
												{{-- falta la TDE --}}
												@case('No Conciliado')
													<td class="text-center"><a data-placement="auto" data-trigger="hover" data-html="true" data-toggle="popover" title="<b>Tarjeta de emergencia no valida</b>" data-content="<p style='width: 50%'>algunas de las cantidades de residuos enviadas a conciliacion ha sido rechazada pro el cliente... <br>Para mas detalles comuníquese con el <b>Asesor Comercial</b> </p>" class='btn fixed_widthbtn btn-warning'><i class='fas fa-lg fa-file-pdf'></i></a>{{$Servicio->SolSerStatus}}</td>
													@break
												{{-- TDE actualizada --}}
												@case('Tratado')
													<td class="text-center"><a data-placement="auto" data-trigger="hover" data-html="true" data-toggle="popover" title="<b>Tarjeta de emergencia actualizada</b>" data-content="<p style='width: 50%'> todos los residuos de este servicio han sido tratados satisfactoriamente... sin embargo el area de tesoreria debera autorizar al cliente para la descarga de manifiestos/Certificados y los Certificados de otros Gestores seran cargados en el Sitema SisPRO segun se vayan recibiendo... <br>Para mas detalles comuníquese con el <b>Jefe de Operaciones</b> </p>" class='btn fixed_widthbtn btn-primary'><i class='fas fa-lg fa-file-pdf'></i></a>{{$Servicio->SolSerStatus}}</td>
													@break
												@case('Certificada')
													<td class="text-center"><a data-placement="auto" data-trigger="hover" data-html="true" data-toggle="popover" title="<b>Tarjeta de emergencia actualizada</b>" data-content="<p style='width: 50%'>Los archivos correspondientes a Certificados ya se encuentran disponibles para su visualizacion y descarga por parte del cliente... el area de Operaciones enviara una notificacion por correo al Asesor Comercial que corresponda en el momento que los Manifiestos/Certificados de Otros Gestores esten disponibles para su descarga desde el sistema <b>SisPRO</b>... <br>Para mas detalles comuníquese con el <b>Asesor Comercial</b> o con el <b>Jefe de Operaciones</b> según corresponda</p>" class='btn fixed_widthbtn btn-primary'><i class='fas fa-lg fa-file-pdf'></i></a>{{$Servicio->SolSerStatus}}</td>
													@break
												{{-- opción default --}}
												@default
													<td class="text-center"><a data-placement="auto" data-trigger="hover" data-html="true" data-toggle="popover" title="<b>Status Indefinido</b>" data-content="<p style='width: 50%'>Status Indefinido... <br>Para mas detalles comuníquese con su <b>Asesor Comercial</b> </p>" class='btn fixed_widthbtn btn-primary'><i class='fas fa-lg fa-ban'></i></a>{{$Servicio->SolSerStatus}}</td>
