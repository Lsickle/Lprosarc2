					...
					<form role="form" action="/permisos/{{$User->UsSlug}}" method="POST" enctype="multipart/form-data"  data-toggle="validator" class="form">
						...
						<div class="box-body">
							<label for="img" style="display:flex; justify-content:center;">
								<img style="cursor:pointer;" class="profile-user-img img-responsive img-circle size-img" src="../../../img/ImagesProfile/{{$User->UsAvatar}}" alt="User profile picture">
							</label>
							...
							<div class="form-group col-md-6">
								...
								<input type="text" name="name" class="form-control" id="name" maxlength="255" required value="{{$User->name}}">
							</div>
							<div class="form-group col-md-6">
