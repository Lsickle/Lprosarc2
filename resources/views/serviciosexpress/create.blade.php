					...
					<div class="box-body">
						<div class="col-md-12">
							<div class="form-group col-md-12" style="padding: 0px;">
								<label data-placement="auto" data-trigger="hover" data-html="true" data-toggle="popover" title="<b>{{'Clientes'}}</b>" data-content="Seleccion el cliente al cual se le va a programar la recoleccion en la modalidad de servicio express"><i style="font-size: 1.8rem; color: Dodgerblue;" class="fas fa-info-circle fa-2x fa-spin"></i>Cliente</label>
							...
							<div class="form-group col-md-12 select-multiple-contenedor" style="padding: 0px;">
							...
							<div id="transportador" class="form-group col-md-6" hidden="true" style="padding: 0px;">
							...
							<div id="nametransportadora" class="form-group col-md-6" hidden="true" style="padding: 0px;">
							...
							<div id="nittransportadora" class="form-group col-md-6" hidden="true" style="padding: 0px;">
							...
							<div id="addresstransportadora" class="form-group col-md-12" hidden="true" style="padding: 0px;">
							...
							<div class="form-group col-md-6 citytransportadora" hidden style="padding: 0px;">
							...
							<div id="Conductor" class="form-group col-md-6" hidden="true" style="padding: 0px;">
							...
							<div id="Vehiculo" class="form-group col-md-6" hidden="true" style="padding: 0px;">
