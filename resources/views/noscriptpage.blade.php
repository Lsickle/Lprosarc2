...
<body>
    <noscript style="text-align: center;">
        <h1>Javascript está deshabilitado</h1>
        <div class="deshabilitado">
            ...
            Para poder ver correctamente la aplicacion <a href="../home"><b>{{ config('app.name') }}</b></a> Por favor...<br />
            <h3>
            ...
            <br />
            <h2>	
            	Si desea ver las instrucciones para habilitar javascript<br />
