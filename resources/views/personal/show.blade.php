        ...
        <div class="col-md-3">
          ...
          <div class="box box-primary">
            <div class="box-body box-profile">
          	...
          	<a href="/clientes/{{$Persona->PersSlug}}/edit" class="btn btn-success btn-block"><b>Editar</b></a>
						<br>
{{--             <form action="/sclientes/create" class="form-group" method="POST">
              @csrf
                <input type="text" name="CliSlug" value="{{$Persona->CliSlug}}" hidden="true">
                <button type="submit" class="btn btn-primary btn-block">Agregar Sede</button>
            </form> --}}
      			<form action="/clientes/{{$Persona->PersSlug}}" class="form-group" method="POST">
      				@csrf
              @method('DELETE')
