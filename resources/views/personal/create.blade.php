												...
												<div class="col-md-12">
													<div id="form-step-1" role="form" data-toggle="validator">
														<div class="form-group col-md-6">
															...
															<small class="help-block with-errors"></small>
															<select name="PersDocType" id="PersDocType" class="form-control select">
																<option value="">{{ trans('adminlte_lang::message.select') }}</option>
														...
														<div class="form-group col-md-6">
															...
															<input data-minlength="6" maxlength="11" name="PersDocNumber" type="text" class="form-control document" id="PersDocNumber" value="{{old('PersDocNumber')}}">
														</div>
														<div class="form-group col-md-6">
