      ...
      <div class="row">
        <div class="col-md-3">
          ...
          <div class="box box-primary">
            ...
            <a href="/tratamiento/{{$tratamiento->ID_Trat}}/edit" class="btn btn-success btn-block"><b>Editar</b></a>
                        <br>
{{--             <form action="/sclientes/create" class="form-group" method="POST">
              @csrf
                ...
                <form action="/tratamiento/{{$tratamiento->ID_Trat}}" class="form-group" method="POST">
                    @csrf
              @method('DELETE')
