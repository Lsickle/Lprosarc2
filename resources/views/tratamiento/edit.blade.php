                      ...
                      <div class="panel-body" id="pretratamientosPanel" onload="attachPopover()">
                        ...
                        <div class="col-md-6" id="pretratdescription{{$contador}}">
                          ...
                          <div class="input-group">
                            ...
                            <a onmouseover="attachPopover()" class="input-group-addon" data-toggle="popover" title="{{ trans('adminlte_lang::LangTratamiento.popovertittle2') }}" data-content="<p style='width: 50%'>{{ trans('adminlte_lang::LangTratamiento.popoverdescript2') }}</p>"><i class="fas fa-info-circle"></i></a>
                          </div>
                        </div>
                        @php
                        $contador = $contador+1;
