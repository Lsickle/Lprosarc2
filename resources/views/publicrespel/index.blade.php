								...
								@foreach($PublicRespels as $respel)
									...
									@if(in_array(Auth::user()->UsRol, Permisos::CLIENTE))
										@switch($respel->RespelStatus)
											...
											{{-- cotización vencida --}}
											@case('Vencido')
												<td class="text-center"><a method='get' href='/respelspublic/{{$respel->RespelSlug}}' data-placement="auto" data-trigger="hover" data-html="true" data-toggle="popover" title="<b>Status Vencido</b>" data-content="<p style='width: 50%'> Las tarifas asignadas a su residuo exceden de la fecha aprobada por lo cual podrian ser facturadas a un precio diferente... <br>Para mas detalles comuníquese con su <b>Asesor Comercial</b> </p>" class='btn fixed_widthbtn btn-danger'><i class='fas fa-lg fa-calendar-times'></i></a></td>
												@break
											{{-- Informacion Incompleta --}}
											@case('Incompleto')
												<td class="text-center"><a method='get' href='/respelspublic/{{$respel->RespelSlug}}' data-placement="auto" data-trigger="hover" data-html="true" data-toggle="popover" title="<b>Status Incompleto</b>" data-content="<p style='width: 50%'> la informacion suministrada en el registro de su residuo no es sufiiente para poder asignar un tratamiento viable... <br>Por favor comuníquese con su <b>Asesor Comercial</b> </p>" class='btn fixed_widthbtn btn-warning'><i class='fas fa-lg fa-tasks'></i></a></td>
												@break
											{{-- Informacion Revisado --}}
											@case('Revisado')
												<td class="text-center"><a method='get' href='/respelspublic/{{$respel->RespelSlug}}' data-placement="auto" data-trigger="hover" data-html="true" data-toggle="popover" title="<b>Status Revisado</b>" data-content="<p style='width: 50%'> su residuo ha sido revisado por el area de logistica y cuenta con la documentacion necesaia para ser transportado por nuestros vehiculos... <br>Para mas detalles comuníquese con su <b>Asesor Comercial</b> </p>" class='btn fixed_widthbtn btn-success'><i class='fas fa-lg fa-check-double'></i></a></td>
												@break
											{{-- Informacion Revisado --}}
											@case('Falta TDE')
												<td class="text-center"><a method='get' href='/respelspublic/{{$respel->RespelSlug}}' data-placement="auto" data-trigger="hover" data-html="true" data-toggle="popover" title="<b>Tarjeta de emergencia no valida</b>" data-content="<p style='width: 50%'> la tarjeta de emergencia adjuntada no corresponde con la información de su residuo, debe adjuntar la tarjeta de emergencia correcta para que sus solicitudes de servicio puedan ser programadas con los vehiculos de <b>Prosarc.ESP.S.A.</b> ... <br>Para mas detalles comuníquese con su <b>Asesor Comercial</b> </p>" class='btn fixed_widthbtn btn-warning'><i class='fas fa-lg fa-file-pdf'></i></a></td>
												@break
											{{-- opción default --}}
											@default
									...
									@else
										@switch($respel->RespelStatus)
											...
											{{-- residuo Rechazado --}}
											@case('Rechazado')
												<td class="text-center"><a method='get' href='/respelspublic/{{$respel->RespelSlug}}/edit' data-placement="auto" data-trigger="hover" data-html="true" data-toggle="popover" title="<b>Status Rechazado</b>" data-content="<p style='width: 50%'> la viabilizacion de su residuo ha sido rechazada y/o no se disponen de tratamientos acordes a sus necesidades... <br>Para mas detalles comuníquese con el <b>Jefe de Operaciones</b> </p>" class='btn fixed_widthbtn btn-danger'><i class='fas fa-lg fa-ban'></i></a></td>
												@break
											{{-- residuo Evaluado --}}
											@case('Evaluado')
											...
											{{-- residuo Aprobado --}}
											@case('Aprobado')
												<td class="text-center"><a method='get' href='/respelspublic/{{$respel->RespelSlug}}/edit' data-placement="auto" data-trigger="hover" data-html="true" data-toggle="popover" title="<b>Status Aprobado</b>" data-content="<p style='width: 50%'> los tratamientos y tarifas del residuo han sido aprobadas por la <b>Subgerencia</b> y el cliente puede comenzar a realizar solicitudes de servicio... es importante revisar la informacion del tratamiento ofertado... <br>Para mas detalles comuníquese con el <b>Asesor Comercial</b> </p>" class='btn fixed_widthbtn btn-success'><i class='fas fa-lg fa-thumbs-up'></i></a></td>
												@break
											{{-- cotización vencida --}}
											@case('Vencido')
												<td class="text-center"><a method='get' href='/respelspublic/{{$respel->RespelSlug}}/edit' data-placement="auto" data-trigger="hover" data-html="true" data-toggle="popover" title="<b>Status Vencido</b>" data-content="<p style='width: 50%'> Las tarifas asignadas al residuo exceden de la fecha negociada por el <b>Asesor Comercial</b> por lo cual podrian ser facturadas a un precio diferente... <br>Para mas detalles comuníquese con el <b>Asesor Comercial</b> </p>" class='btn fixed_widthbtn btn-danger'><i class='fas fa-lg fa-calendar-times'></i></a></td>
												@break
											{{-- información del residuo incompleta --}}
											@case('Incompleto')
												<td class="text-center"><a method='get' href='/respelspublic/{{$respel->RespelSlug}}/edit' data-placement="auto" data-trigger="hover" data-html="true" data-toggle="popover" title="<b>Status Incompleto</b>" data-content="<p style='width: 50%'> la informacion suministrada en el registro de su residuo no es sufiiente para poder asignar un tratamiento viable... <br>Para mas detalles comuníquese con el <b>Asesor Comercial</b> </p>" class='btn fixed_widthbtn btn-warning'><i class='fas fa-lg fa-tasks'></i></a></td>
												@break
											{{-- Residuo Revisado --}}
											@case('Revisado')
											...
											{{-- falta la TDE --}}
											@case('Falta TDE')
												<td class="text-center"><a method='get' href='/respelspublic/{{$respel->RespelSlug}}/edit' data-placement="auto" data-trigger="hover" data-html="true" data-toggle="popover" title="<b>Tarjeta de emergencia no valida</b>" data-content="<p style='width: 50%'> la tarjeta de emergencia adjuntada no corresponde con la información del residuo, el cliente debe adjuntar la tarjeta de emergencia correcta para que las solicitudes de servicio puedan ser programadas con los vehiculos de <b>Prosarc.ESP.S.A.</b> ... <br>Para mas detalles comuníquese con el <b>Asesor Comercial</b> </p>" class='btn fixed_widthbtn btn-warning'><i class='fas fa-lg fa-file-pdf'></i></a></td>
												@break
											{{-- opción default --}}
											@default
