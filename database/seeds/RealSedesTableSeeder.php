...
class RealSedesTableSeeder extends Seeder
{
    ...
    public function run()
    {
		...
		$sede->SedeEmail = 'ProsarcS.A.ESP.(principal)@gmail.com';
		$sede->FK_SedeCli = '1';
		$sede->FK_SedeMun = '584';
		...
		$sede->SedeEmail = 'ECOCAPITALINTERNACIONALS.AESP.(principal)@gmail.com';
		$sede->FK_SedeCli = '2';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'ENCAJESS.A(principal)@gmail.com';
		$sede->FK_SedeCli = '3';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'DRAGONOILSERVICES(principal)@gmail.com';
		$sede->FK_SedeCli = '4';
		$sede->FK_SedeMun = '584';
		...
		$sede->SedeEmail = 'CI.SUNSHINEBOUQUETCOLOMBIAS.A.S(principal)@gmail.com';
		$sede->FK_SedeCli = '5';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'CMAINGENIERIAYCONSTRUCTORESS.A.S(principal)@gmail.com';
		$sede->FK_SedeCli = '6';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'SMITH&NEPHEWCOLOMBIAS.A.S(principal)@gmail.com';
		$sede->FK_SedeCli = '7';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'DARPLASSAS(principal)@gmail.com';
		$sede->FK_SedeCli = '8';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'LABORATORIOSCHALVERDECOLOMBIAS.A(principal)@gmail.com';
		$sede->FK_SedeCli = '9';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'MEDTRONICCOLOMBIA(principal)@gmail.com';
		$sede->FK_SedeCli = '10';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'CREATIVECOLORSS.A(principal)@gmail.com';
		$sede->FK_SedeCli = '11';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'INSTITUTOGEOGRÁFICOAGUSTÍNCODAZZI(principal)@gmail.com';
		$sede->FK_SedeCli = '12';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'CERESCOSSAS(principal)@gmail.com';
		$sede->FK_SedeCli = '13';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'INTERNATIONALFLAVORSANDFRAGRANCESCOLOMBIAS.A.S.(principal)@gmail.com';
		$sede->FK_SedeCli = '14';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'JOHNSON&JOHNSONDECOLOMBIAS.A.(principal)@gmail.com';
		$sede->FK_SedeCli = '15';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'ENERGIZERDECOLOMBIAS.A.(principal)@gmail.com';
		$sede->FK_SedeCli = '16';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'HUNTSMANCOLOMBIALTDA(principal)@gmail.com';
		$sede->FK_SedeCli = '17';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'PEPSICOALIMENTOSCOLOMBIALTDA(principal)@gmail.com';
		$sede->FK_SedeCli = '18';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'PROQUIFARS.A(principal)@gmail.com';
		$sede->FK_SedeCli = '19';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'LABORATORIOSINDUSTRIALESLPS(principal)@gmail.com';
		$sede->FK_SedeCli = '20';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'HOSPITALCENTRALDELAPOLICIANACIONAL-HOCEN(principal)@gmail.com';
		$sede->FK_SedeCli = '21';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'BRENNTAGCOLOMBIAS.A(principal)@gmail.com';
		$sede->FK_SedeCli = '22';
		$sede->FK_SedeMun = '584';
		...
		$sede->SedeEmail = 'PRODUCTOSQUÍMICOSPANAMERICANOSS.A(principal)@gmail.com';
		$sede->FK_SedeCli = '23';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'ELILILLYINTERAMERICAINC(principal)@gmail.com';
		$sede->FK_SedeCli = '24';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'CHALLENGERSAS(principal)@gmail.com';
		$sede->FK_SedeCli = '25';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'QUIMIAS.A.S(principal)@gmail.com';
		$sede->FK_SedeCli = '26';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'GREIFCOLOMBIAS.A.S(principal)@gmail.com';
		$sede->FK_SedeCli = '27';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'SERVEXCOLOMBIAS.A.S(principal)@gmail.com';
		$sede->FK_SedeCli = '28';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'BIOMÉRIEUXCOLOMBIASAS(principal)@gmail.com';
		$sede->FK_SedeCli = '29';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'LABORATORIOHOMEOPÁTICOALEMÁN(principal)@gmail.com';
		$sede->FK_SedeCli = '30';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'PEPSICOALIMENTOSZONAFRANCA(principal)@gmail.com';
		$sede->FK_SedeCli = '31';
		$sede->FK_SedeMun = '557';
		...
		$sede->SedeEmail = 'PRODUCTOSROCHES.A(principal)@gmail.com';
		$sede->FK_SedeCli = '32';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'CONGRUPOS.A.(principal)@gmail.com';
		$sede->FK_SedeCli = '33';
		$sede->FK_SedeMun = '551';
		...
		$sede->SedeEmail = 'KYROVETLABORATORIESS.A(principal)@gmail.com';
		$sede->FK_SedeCli = '34';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'ALIMENTOSCARNICOSS.A.S(principal)@gmail.com';
		$sede->FK_SedeCli = '35';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'LABORATORIOSPHITOTHERS.A.S(principal)@gmail.com';
		$sede->FK_SedeCli = '36';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'CAJADECOMPENSACIONFAMILIARCAFAM(principal)@gmail.com';
		$sede->FK_SedeCli = '37';
		...
		$sede->SedeEmail = 'NACIONALDETRENZADOSS.A.(principal)@gmail.com';
		$sede->FK_SedeCli = '38';
		$sede->FK_SedeMun = '557';
		...
		$sede->SedeEmail = 'CEMEXCOLOMBIAS.A.(principal)@gmail.com';
		$sede->FK_SedeCli = '39';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'QUIMEXCOLZONAFRANCASAS(principal)@gmail.com';
		$sede->FK_SedeCli = '40';
		$sede->FK_SedeMun = '624';
		...
		$sede->SedeEmail = 'SUMMITAGROCOLOMBIAS.A.S(principal)@gmail.com';
		$sede->FK_SedeCli = '41';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'FRAYCOS.A.S(principal)@gmail.com';
		$sede->FK_SedeCli = '42';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'FUNDACIONUNIVERSITARIADECIENCIASDELASALUD(FUCS)(principal)@gmail.com';
		$sede->FK_SedeCli = '43';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'COPROPIEDADZONAFRANCAPERMANENTEINTEXZONA(principal)@gmail.com';
		$sede->FK_SedeCli = '44';
		$sede->FK_SedeMun = '557';
		...
		$sede->SedeEmail = 'AGQPRODYCONCOLOMBIAS.A.S(principal)@gmail.com';
		$sede->FK_SedeCli = '45';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'SKFLATINAMERICANLTDA(principal)@gmail.com';
		$sede->FK_SedeCli = '46';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'AMERICANEMBASSYBOGOTA(principal)@gmail.com';
		$sede->FK_SedeCli = '47';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'LINDECOLOMBIAS.A.(principal)@gmail.com';
		$sede->FK_SedeCli = '48';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'FUNDICOMS.A.S(principal)@gmail.com';
		$sede->FK_SedeCli = '49';
		$sede->FK_SedeMun = '584';
		...
		$sede->SedeEmail = 'C.IINTERAMERICANCONMINASS.A.S(principal)@gmail.com';
		$sede->FK_SedeCli = '50';
		$sede->FK_SedeMun = '618';
		...
		$sede->SedeEmail = 'TECSERLABORATORIOSS.A(principal)@gmail.com';
		$sede->FK_SedeCli = '51';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'IRONMOUNTAIN(principal)@gmail.com';
		$sede->FK_SedeCli = '52';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'TEOFARMSS.A.S(principal)@gmail.com';
		$sede->FK_SedeCli = '53';
		$sede->FK_SedeMun = '566';
		...
		$sede->SedeEmail = 'INSTITUTONACIONALDEVIGILANCIADEMEDICAMENTOSYALIMENTOS–INVIMA(principal)@gmail.com';
		$sede->FK_SedeCli = '54';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'ECORESIDUOSNACIONALESS.A.SESP(principal)@gmail.com';
		$sede->FK_SedeCli = '55';
		$sede->FK_SedeMun = '584';
		...
		$sede->SedeEmail = 'LABORATORIOSALCONCOLOMBIAS.A.(principal)@gmail.com';
		$sede->FK_SedeCli = '56';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'POLYUPROTEC(principal)@gmail.com';
		$sede->FK_SedeCli = '57';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'ASCENSORESSCHINDLERDECOLOMBIASAS(principal)@gmail.com';
		$sede->FK_SedeCli = '58';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'CASAMOBLESAYCIASAS(principal)@gmail.com';
		$sede->FK_SedeCli = '59';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'TEXASOILTECHLABORATORIES(principal)@gmail.com';
		$sede->FK_SedeCli = '60';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'PREMEXS.A(principal)@gmail.com';
		$sede->FK_SedeCli = '61';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'PROCESS,INTELLIGENTBUSINESS&TECHNOLOGYS.A.S(principal)@gmail.com';
		$sede->FK_SedeCli = '62';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'CLINICAMIOCARDIOS.A.S(principal)@gmail.com';
		$sede->FK_SedeCli = '63';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'IMPROBELLLTDA(principal)@gmail.com';
		$sede->FK_SedeCli = '64';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'IBEROAMERICANADEPLÁSTICOSS.A.S(principal)@gmail.com';
		$sede->FK_SedeCli = '65';
		$sede->FK_SedeMun = '581';
		...
		$sede->SedeEmail = 'WASTEANDENVIRONMENTALSERVICESS.A.S(principal)@gmail.com';
		$sede->FK_SedeCli = '66';
		$sede->FK_SedeMun = '551';
		...
		$sede->SedeEmail = 'ALBATEQS.A(principal)@gmail.com';
		$sede->FK_SedeCli = '67';
		$sede->FK_SedeMun = '584';
		...
		$sede->SedeEmail = 'AGROSERS.A(principal)@gmail.com';
		$sede->FK_SedeCli = '68';
		$sede->FK_SedeMun = '620';
		...
		$sede->SedeEmail = 'BELSTARS.A(principal)@gmail.com';
		$sede->FK_SedeCli = '69';
		$sede->FK_SedeMun = '624';
		...
		$sede->SedeEmail = 'CORPORACIÓNPUNTOAZUL(principal)@gmail.com';
		$sede->FK_SedeCli = '70';
		$sede->FK_SedeMun = '551';
		...
		$sede->SedeEmail = 'TECNOLOGIAPLASTICATECNOSAS.A.S(principal)@gmail.com';
		$sede->FK_SedeCli = '71';
		$sede->FK_SedeMun = '581';
		...
		$sede->SedeEmail = 'YANBALDECOLOMBIAS.A.S(principal)@gmail.com';
		$sede->FK_SedeCli = '72';
		$sede->FK_SedeMun = '636';
		...
		$sede->SedeEmail = 'FIBERGLASSCOLOMBIAS.A(principal)@gmail.com';
		$sede->FK_SedeCli = '73';
		$sede->FK_SedeMun = '584';
		...
		$sede->SedeEmail = 'CAPECOLOMBIAS.A.S.(principal)@gmail.com';
		$sede->FK_SedeCli = '74';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'PROQUINALS.A(principal)@gmail.com';
		$sede->FK_SedeCli = '75';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'CPLAROMASCOLOMBIALTDA(principal)@gmail.com';
		$sede->FK_SedeCli = '76';
		$sede->FK_SedeMun = '557';
		...
		$sede->SedeEmail = 'RATARS.A.S(principal)@gmail.com';
		$sede->FK_SedeCli = '77';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'SCANDINAVIAPHARMA(principal)@gmail.com';
		$sede->FK_SedeCli = '78';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'FLEXOGRAFICAS(principal)@gmail.com';
		$sede->FK_SedeCli = '79';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'TUBULARRUNNING&RENTALSERVICESSAS(principal)@gmail.com';
		$sede->FK_SedeCli = '80';
		$sede->FK_SedeMun = '584';
		...
		$sede->SedeEmail = 'COLECTAS.A(principal)@gmail.com';
		$sede->FK_SedeCli = '81';
		$sede->FK_SedeMun = '636';
		...
		$sede->SedeEmail = 'SYMRISELTDA.(principal)@gmail.com';
		$sede->FK_SedeCli = '82';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'FLAMINGOOILS.A(principal)@gmail.com';
		$sede->FK_SedeCli = '83';
		$sede->FK_SedeMun = '557';
		...
		$sede->SedeAddress = 'CARRERA 127 No. 22 G - 15 CENTRO DE DISTRIBUCIÓN NO. 8-9-10 PARQUE INDUSTRIAL EL DORADO';
		$sede->SedeEmail = 'SUMITOMOCORPORATIONCOLOMBIAS.A.S.(principal)@gmail.com';
		$sede->FK_SedeCli = '84';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'BAGUTSAS(principal)@gmail.com';
		$sede->FK_SedeCli = '85';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'EXPRESOANDINODECARGAS.A(principal)@gmail.com';
		$sede->FK_SedeCli = '86';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'FRANAINTERNATIONALS.A.S(principal)@gmail.com';
		$sede->FK_SedeCli = '87';
		$sede->FK_SedeMun = '624';
		...
		$sede->SedeEmail = 'PINTURASSUPERLTDA(principal)@gmail.com';
		$sede->FK_SedeCli = '88';
		$sede->FK_SedeMun = '584';
		...
		$sede->SedeEmail = 'SOCIEDADHOTELERATEQUENDAMA(principal)@gmail.com';
		$sede->FK_SedeCli = '89';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'GAIAVITARES.A.S(principal)@gmail.com';
		$sede->FK_SedeCli = '90';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'STANTONS.A.S(principal)@gmail.com';
		$sede->FK_SedeCli = '91';
		$sede->FK_SedeMun = '608';
		...
		$sede->SedeEmail = 'ORGANIZACIÓNTERPELS.A(principal)@gmail.com';
		$sede->FK_SedeCli = '92';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'AMGDECOLOMBIALTDA(principal)@gmail.com';
		$sede->FK_SedeCli = '93';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'RITCHIS.A.S(principal)@gmail.com';
		$sede->FK_SedeCli = '94';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'HILVERDAKOOIJCOLOMBIASAS(principal)@gmail.com';
		$sede->FK_SedeCli = '95';
		$sede->FK_SedeMun = '554';
		...
		$sede->SedeEmail = 'BAXALTAS.A(principal)@gmail.com';
		$sede->FK_SedeCli = '96';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'WORLDMEDICALS.A.S(principal)@gmail.com';
		$sede->FK_SedeCli = '97';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'EXXONMOBILDECOLOMBIAS.A(principal)@gmail.com';
		$sede->FK_SedeCli = '98';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'UNIDADDEGESTIÓNAMBIENTALLTDA(principal)@gmail.com';
		$sede->FK_SedeCli = '99';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'KHEMRATECHNOLOGIES(principal)@gmail.com';
		$sede->FK_SedeCli = '100';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'PFIZERS.A.S(principal)@gmail.com';
		$sede->FK_SedeCli = '101';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'BAYERS.A(principal)@gmail.com';
		$sede->FK_SedeCli = '102';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeAddress = 'CRA.106 NO.15-25 MANZ.6 LOTE 28 Y 29';
		$sede->SedeEmail = 'CHALVERS.A(principal)@gmail.com';
		$sede->FK_SedeCli = '103';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'NOVARTISDECOLOMBIA(principal)@gmail.com';
		$sede->FK_SedeCli = '104';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'TERUMOBCTCOLOMBIAS.A(principal)@gmail.com';
		$sede->FK_SedeCli = '105';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'COASPHARMAS.A.S(principal)@gmail.com';
		$sede->FK_SedeCli = '106';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'YOURWAYTRANSPORTBIOSERVICESCOLOMBIAS.A.S.(principal)@gmail.com';
		$sede->FK_SedeCli = '107';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'PROEMPACKCOLOMBIAS.A.S(principal)@gmail.com';
		$sede->FK_SedeCli = '108';
		$sede->FK_SedeMun = '551';
		...
		$sede->SedeEmail = 'HOYFARMAS.A.S(principal)@gmail.com';
		$sede->FK_SedeCli = '109';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'COMPAÑÍACALIFORNIA(principal)@gmail.com';
		$sede->FK_SedeCli = '110';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeAddress = 'CALLE 17 NO. 34-64';
		$sede->SedeEmail = 'MEMPHISPRODUCTSS.A.(principal)@gmail.com';
		$sede->FK_SedeCli = '111';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'ECOLOGIAYENTORNOS.A.SESP-ECOENTORNO(principal)@gmail.com';
		$sede->FK_SedeCli = '112';
		$sede->FK_SedeMun = '584';
		...
		$sede->SedeEmail = 'LABORATORIOFDA(principal)@gmail.com';
		$sede->FK_SedeCli = '113';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeAddress = 'CALLE 20A NO. 43A - 50 INTERIOR 6';
		$sede->SedeEmail = 'ARBOFARMAS.A.S.(principal)@gmail.com';
		$sede->FK_SedeCli = '114';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'FRACOS.A(principal)@gmail.com';
		$sede->FK_SedeCli = '115';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'BLULOGISTICS(principal)@gmail.com';
		$sede->FK_SedeCli = '116';
		$sede->FK_SedeMun = '620';
		...
		$sede->SedeEmail = 'DUFLOS.A.S(principal)@gmail.com';
		$sede->FK_SedeCli = '117';
		$sede->FK_SedeMun = '551';
		...
		$sede->SedeEmail = 'RICHDECOLOMBIAS.A.S(principal)@gmail.com';
		$sede->FK_SedeCli = '118';
		$sede->FK_SedeMun = '557';
		...
		$sede->SedeEmail = 'DIVERSEYCOLOMBIAS.A.S(principal)@gmail.com';
		$sede->FK_SedeCli = '119';
		$sede->FK_SedeMun = '551';
		...
		$sede->SedeEmail = 'CLARIANTPLASTICS&COATINGS(COLOMBIA)SAS(principal)@gmail.com';
		$sede->FK_SedeCli = '120';
		$sede->FK_SedeMun = '551';
		...
		$sede->SedeEmail = 'CONSTRUCCENTER(principal)@gmail.com';
		$sede->FK_SedeCli = '121';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'INMEVALS.A.S(principal)@gmail.com';
		$sede->FK_SedeCli = '122';
		$sede->FK_SedeMun = '557';
		...
		$sede->SedeEmail = 'ACMELEONPLASTICOS(principal)@gmail.com';
		$sede->FK_SedeCli = '123';
		$sede->FK_SedeMun = '557';
		...
		$sede->SedeEmail = 'AGROINDUSTRIADELRIOFRIOSAS(principal)@gmail.com';
		$sede->FK_SedeCli = '124';
		$sede->FK_SedeMun = '530';
		...
		$sede->SedeEmail = 'POLLOOLYMPICOS.A(principal)@gmail.com';
		$sede->FK_SedeCli = '125';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'SERVIVIRSERVICIOSMEDICOSINTEGRALES(principal)@gmail.com';
		$sede->FK_SedeCli = '126';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeAddress = 'AUTOPISTA MEDELLIN KM 2.5: VIA PARCELAS KM 1: VEREDA SIBERIA';
		$sede->SedeEmail = 'CLARIANTDECOLOMBIAS.A(principal)@gmail.com';
		$sede->FK_SedeCli = '127';
		$sede->FK_SedeMun = '551';
		...
		$sede->SedeEmail = 'FUMIGACIONESYOUNGLTDA(principal)@gmail.com';
		$sede->FK_SedeCli = '128';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'GASEOSASLUXS.A.S(principal)@gmail.com';
		$sede->FK_SedeCli = '129';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'PRODUCTOSJACOBSEN(principal)@gmail.com';
		$sede->FK_SedeCli = '130';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'ADMINISTRAMOSYTRANSPORTAMOSS.A.S(principal)@gmail.com';
		$sede->FK_SedeCli = '131';
		$sede->FK_SedeMun = '624';
		...
		$sede->SedeEmail = 'DISTRIQUIMICOSALDIRS.A.S(principal)@gmail.com';
		$sede->FK_SedeCli = '132';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'PRODESEGS.A(principal)@gmail.com';
		$sede->FK_SedeCli = '133';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'CONTINENTALDEFUMIGACIONESLTDA.(principal)@gmail.com';
		$sede->FK_SedeCli = '134';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'FADIVETS.A.S(principal)@gmail.com';
		$sede->FK_SedeCli = '135';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'ARCOPESTCONTROLLTDA(principal)@gmail.com';
		$sede->FK_SedeCli = '136';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'EXROS.A.S.(principal)@gmail.com';
		$sede->FK_SedeCli = '137';
		$sede->FK_SedeMun = '624';
		...
		$sede->SedeEmail = 'EMBOPACKS.A.S(principal)@gmail.com';
		$sede->FK_SedeCli = '138';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'PROCESADORADELECHES.A(principal)@gmail.com';
		$sede->FK_SedeCli = '139';
		$sede->FK_SedeMun = '12';
		...
		$sede->SedeEmail = 'COMPAÑÍADETRABAJOSURBANOSS.A(principal)@gmail.com';
		$sede->FK_SedeCli = '140';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'MEDINARIVERAINGENIEROSASOCIADOSS.A.S(principal)@gmail.com';
		$sede->FK_SedeCli = '141';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'DICOS.A(principal)@gmail.com';
		$sede->FK_SedeCli = '142';
		$sede->FK_SedeMun = '584';
		...
		$sede->SedeEmail = 'SACMAS.A.S(principal)@gmail.com';
		$sede->FK_SedeCli = '143';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'ECOFLORAS.A.S(principal)@gmail.com';
		$sede->FK_SedeCli = '144';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'QUIMITRONICALTDA(principal)@gmail.com';
		$sede->FK_SedeCli = '145';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'LABORATORIOSFARPAGS.A.S(principal)@gmail.com';
		$sede->FK_SedeCli = '146';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'UNIVERSIDADCENTRAL(principal)@gmail.com';
		$sede->FK_SedeCli = '147';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'VULCATECS.A.S(principal)@gmail.com';
		$sede->FK_SedeCli = '148';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'FUMIGARYSERVICIOSLTDA.(principal)@gmail.com';
		$sede->FK_SedeCli = '149';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'POLITÉCNICOGRANCOLOMBIANO(principal)@gmail.com';
		$sede->FK_SedeCli = '150';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'HELBERTYCIAS.A(principal)@gmail.com';
		$sede->FK_SedeCli = '151';
		$sede->FK_SedeMun = '551';
		...
		$sede->SedeEmail = 'LAMINADOSTYT(principal)@gmail.com';
		$sede->FK_SedeCli = '152';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeAddress = 'CALLE 17 N° 68-51 ZONA INDUSTRIAL DE MONTEVIDEO';
		$sede->SedeEmail = 'POLYCELTS.A.S.(principal)@gmail.com';
		$sede->FK_SedeCli = '153';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'EDSESSOVERBENAL(principal)@gmail.com';
		$sede->FK_SedeCli = '154';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'RSRECTIFICADORADEMOTORESSABOGAL-BATERIASYREPUESTOSS.A.S(principal)@gmail.com';
		$sede->FK_SedeCli = '155';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'CONSORCIOMALLAVIALCUNDINAMARCA(principal)@gmail.com';
		$sede->FK_SedeCli = '156';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'FUMIGACIONESYDISTRIBUCIONESZETAS.A.S(principal)@gmail.com';
		$sede->FK_SedeCli = '157';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'POLYAROMASLTDA(principal)@gmail.com';
		$sede->FK_SedeCli = '158';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'INSTITUTOAMAZONICODEINVESTIGACIONESCIENTIFICAS“SINCHI”(principal)@gmail.com';
		$sede->FK_SedeCli = '159';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'MINISTERIODESALUDYPROTECCIONSOCIAL(principal)@gmail.com';
		$sede->FK_SedeCli = '160';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'COMPASSGROUPSERVICESCOLOMBIA(principal)@gmail.com';
		$sede->FK_SedeCli = '161';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'PRODUCTOSSTAHLDECOLOMBIAS.A.(principal)@gmail.com';
		$sede->FK_SedeCli = '162';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'GRUPOQUIROMARSAS(principal)@gmail.com';
		$sede->FK_SedeCli = '163';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'PROYECTOSAMBIENTALESS.A.SESP(principal)@gmail.com';
		$sede->FK_SedeCli = '164';
		...
		$sede->SedeEmail = 'ALMAVIVAS.A(principal)@gmail.com';
		$sede->FK_SedeCli = '165';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'BIOLOGICOSYCONTAMINADOS(principal)@gmail.com';
		$sede->FK_SedeCli = '166';
		$sede->FK_SedeMun = '584';
		...
		$sede->SedeEmail = 'GRUPOKOPELLELTDA.(principal)@gmail.com';
		$sede->FK_SedeCli = '167';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'IMECS.A.ESP(principal)@gmail.com';
		$sede->FK_SedeCli = '168';
		$sede->FK_SedeMun = '740';
		...
		$sede->SedeEmail = 'IPSFERNANDOKUANMEDINAS.A.S(principal)@gmail.com';
		$sede->FK_SedeCli = '169';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'MACROMEDS.A.S(principal)@gmail.com';
		$sede->FK_SedeCli = '170';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'ASEIS.A.S(principal)@gmail.com';
		$sede->FK_SedeCli = '171';
		$sede->FK_SedeMun = '65';
		...
		$sede->SedeEmail = 'EXIAGRICOLAJDLTDA(principal)@gmail.com';
		$sede->FK_SedeCli = '172';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'HANDLERS.A.S(principal)@gmail.com';
		$sede->FK_SedeCli = '173';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'APOTECARIUMLTDA(principal)@gmail.com';
		$sede->FK_SedeCli = '174';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'ENERGÍAINTEGRALANDINAS.A.(principal)@gmail.com';
		$sede->FK_SedeCli = '175';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'HIDROPROTECCIÓNS.A(principal)@gmail.com';
		$sede->FK_SedeCli = '176';
		$sede->FK_SedeMun = '557';
		...
		$sede->SedeEmail = 'ASEPSISPRODUCTSDECOLOMBIAS.A.S.PROASEPSISS.A.S.(principal)@gmail.com';
		$sede->FK_SedeCli = '177';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'LABORATORIOHOMEOPATICOLONDON(principal)@gmail.com';
		$sede->FK_SedeCli = '178';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'UNISERVICE(principal)@gmail.com';
		$sede->FK_SedeCli = '179';
		$sede->FK_SedeMun = '169';
		...
		$sede->SedeEmail = 'FLORVALS.A.S(principal)@gmail.com';
		$sede->FK_SedeCli = '180';
		$sede->FK_SedeMun = '586';
