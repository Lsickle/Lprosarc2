...
class RealSedesTableSeeder extends Seeder
{
    ...
    {		
		...
		/*id = 03*/
		$sede = new Sede();
		$sede->SedeName = 'Sede Administrativa';
		$sede->SedeAddress = 'bogota 11th street # 18-5';
		$sede->SedeEmail = 'admin@testclient.com';
		$sede->FK_SedeCli = '2';
		$sede->FK_SedeMun = '169';
		$sede->SedeSlug = hash('sha256', rand().time().$sede->SedeAddress);
		$sede->SedeDelete = 0;
		...
		/*id = 04*/
		$sede = new Sede();
		$sede->SedeName = 'Sede Operativa';
		$sede->SedeAddress = 'KILÓMETRO 4 VÍA Funza-siberia';
		$sede->SedeEmail = 'operaciones@testclient.com';
		$sede->FK_SedeCli = '2';
		$sede->FK_SedeMun = '557';
		$sede->SedeSlug = hash('sha256', rand().time().$sede->SedeAddress);
		$sede->SedeDelete = 0;
		...
		$sede = new Sede();
		$sede->SedeName = 'Bogotá';
		$sede->SedeAddress = 'bogota 5th avenue # 18-5';
		$sede->SedeEmail = 'bogota@TestCorporation.com';
		$sede->FK_SedeCli = '3';
		$sede->FK_SedeMun = '169';
		$sede->SedeSlug = hash('sha256', rand().time().$sede->SedeAddress);
		$sede->SedeDelete = 0;
		...
		/*id = 06*/
		$sede = new Sede();
		$sede->SedeName = 'planta produccion 1';
		$sede->SedeAddress = 'KILÓMETRO 7 VÍA rosal-siberia';
		$sede->SedeEmail = 'produccion@TestCorporation.com';
		$sede->FK_SedeCli = '3';
		$sede->FK_SedeMun = '169';
		$sede->SedeSlug = hash('sha256', rand().time().$sede->SedeAddress);
		$sede->SedeDelete = 0;
		...
		/*id = 07*/
		$sede = new Sede();
		$sede->SedeName = 'veolia mosquera';
		$sede->SedeAddress = 'PLANTA : Vereda Balsillas';
		$sede->SedeEmail = 'logistica@veolia.com';
		$sede->FK_SedeCli = '4';
		$sede->FK_SedeMun = '584';
		$sede->SedeSlug = hash('sha256', rand().time().$sede->SedeAddress);
		$sede->SedeDelete = 0;
		...
		/*id = 08*/
		$sede = new Sede();
		$sede->SedeName = 'Suppla Cargo Sol-Funza';
		$sede->SedeAddress = 'km 1 via Funza-siberia pque industrial Sol-Funza';
		$sede->SedeEmail = 'logisticasolfunza@Suppla.com';
		$sede->FK_SedeCli = '5';
		$sede->FK_SedeMun = '557';
		$sede->SedeSlug = hash('sha256', rand().time().$sede->SedeAddress);
		$sede->SedeDelete = 0;
		...
		/*id = 09*/
		$sede = new Sede();
		$sede->SedeName = 'Suppla Cargo intexzona';
		$sede->SedeAddress = 'km 1 via Funza-siberia pque industrial intexzona';
		$sede->SedeEmail = 'logisticaintexzona@Suppla.com';
		$sede->FK_SedeCli = '5';
		$sede->FK_SedeMun = '557';
		$sede->SedeSlug = hash('sha256', rand().time().$sede->SedeAddress);
		$sede->SedeDelete = 0;
		...
		/*id = 10*/
		$sede = new Sede();
		$sede->SedeName = 'planta tratamiento';
		$sede->SedeAddress = 'km 6 via mosquera-la mesa, sub estacion balsillas, vereda balsillas';
		$sede->SedeEmail = 'planta@tracol.com';
		$sede->FK_SedeCli = '6';
		$sede->FK_SedeMun = '584';
		$sede->SedeSlug = hash('sha256', rand().time().$sede->SedeAddress);
		$sede->SedeDelete = 0;
		...
		/*id = 11*/
		$sede = new Sede();
		$sede->SedeName = 'principal cundinamarca';
		$sede->SedeAddress = 'calle 80 #68-25';
		$sede->SedeEmail = 'transportes@ExpresoAndino.com';
		$sede->FK_SedeCli = '7';
		$sede->FK_SedeMun = '169';
		$sede->SedeSlug = hash('sha256', rand().time().$sede->SedeAddress);
		$sede->SedeDelete = 0;
